<?php
   ...
   $dashboard_found	=	0;
	...
	$class_table_mapping      = $wpdb->prefix . 'wpts_class_mapping';
	...
	$messages_table_delete    = $wpdb->prefix . 'wpts_messages_delete';
...
$sql_student = "CREATE TABLE $student_table  (
	...
	$sql_fees = $wpdb->prefix . 'wpts_fees';
	...
	$sql_fees_payment = $wpdb->prefix . 'wpts_fees_payment';
	...
	$table_fee_payment_history = $wpdb->prefix . 'wpts_fee_payment_history';
	...
	if(!strpos($htaccess,$wptsmax))

	file_put_contents($htaccess,$contents.$wptsmax);
