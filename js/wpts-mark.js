jQuery(document).ready(function() {
  ...
  $('.MarkAction').click(function(e) {
    ...
    if (err != '') {
      e.preventDefault();
      $(".wpts-popup-return-data").html(err);
  ...
  $('#AddMark_Submit').click(function(e) {
    ...
    if (empty < 1) {
      ...
      jQuery.ajax({
        ...
        success: function(response) {
          if (response == 'success') {
            ...
            $(".wpts-popup-return-data").html('Marks Saved Successfully');
            ...
            $(".wpts-popup-return-data").html('Marks Entry failed');
            $("#SavingModal").css("display", "none");
            $("#WarningModal").css("display", "block");
            $("#WarningModal").addClass("wpts-popVisible");
          } else if (response == 'update') {
            $(".wpts-popup-return-data").html('Marks Updated Successfully');
            $("#SuccessModal").css("display", "block");
            $("#SavingModal").css("display", "none");
            $("#SuccessModal").addClass("wpts-popVisible");
            setTimeout(function() {
            ...
            $(".wpts-popup-return-data").html(response);
            $("#SavingModal").css("display", "none");
            $("#WarningModal").css("display", "block");
            $("#WarningModal").addClass("wpts-popVisible");
          }
      ...
      $(".wpts-popup-return-data").html('Mark Box Should not be Empty, Mark Absentees as AB.');
      $("#SavingModal").css("display", "none");
      $("#WarningModal").css("display", "block");
      $("#WarningModal").addClass("wpts-popVisible");
    }
...
if ($(window).width() < 991) {   $('#verticalTab').find('.wpts-resp-tab-active').removeClass('wpts-resp-tab-active');
