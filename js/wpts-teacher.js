$(document).ready(function() {
  ...
  $("#wpts_leave_days").on("click", ".wpts-popclick", function() {
    var e = $(this).attr("data-pop");
    $("#" + e).addClass("wpts-popVisible"), $("body").addClass("wpts-bodyFixed")
    ...
    submitHandler: function(e) {
      ...
      a.append("action", "UpdateTeacher"), a.append("displaypicture", t), $.each(s, function(e, s) {
        ...
        success: function(e) {
          if ("success0" == e) {
            $(".wpts-popup-return-data").html("Teacher Updated successfully !"), $("#SuccessModal").css("display", "block"), $("#SavingModal").css("display", "none"), $("#SuccessModal").addClass("wpts-popVisible");
            var a = $("#wpts_locationginal").val() + "/admin.php?page=sch-teacher";
            setTimeout(function() {
              window.location.href = a
            }, 1e3);
            $("#TeacherEditForm").trigger("reset"), $("#u_teacher").attr("disabled", "disabled")
          } else $(".wpts-popup-return-data").html(e), $("#SavingModal").css("display", "none"), $("#WarningModal").css("display", "block"), $("#WarningModal").addClass("wpts-popVisible")
        },
        error: function() {
      ...
      a.append("displaypicture", t), a.append("action", "AddTeacher"), $.each(s, function(e, s) {
        ...
        success: function(e) {
          if ($("#teacherform").removeAttr("disabled"), "success" == e) {
            $(".wpts-popup-return-data").html("Teacher added successfully !"), $("#SuccessModal").css("display", "block"), $("#SavingModal").css("display", "none"), $("#SuccessModal").addClass("wpts-popVisible");
            var a = $("#wpts_locationginal").val() + "/admin.php?page=sch-teacher";
            setTimeout(function() {
              window.location.href = a
            }, 1e3)
        ...
        error: function() {
          $("#SavingModal").css("display", "none"), $("#WarningModal").css("display", "block"), $("#WarningModal").addClass("wpts-popVisible"), $("#teacherform").removeAttr("disabled")
        },
        complete: function() {
    ...
    s.push({
      ...
      "success" == e ? location.reload() : ($(".wpts-popup-return-data").html("Operation failed.Something went wrong!"), $("#SavingModal").css("display", "none"), $("#WarningModal").css("display", "block"), $("#WarningModal").addClass("wpts-popVisible"))
    })
    ...
    if ("bulkUsersDelete" == $(this).val()) {
      ...
      if (0 == e.length) return $(".wpts-popup-return-data").html("No user selected!"), $("#SavingModal").css("display", "none"), $("#WarningModal").css("display", "block"), $("#WarningModal").addClass("wpts-popVisible"), !1;
