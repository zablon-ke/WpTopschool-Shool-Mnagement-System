  ...
  $(document).on("click", ".checkAll", function(e) {
    ...
    if (e.preventDefault(), $('input[type="checkbox"]:checked').length > 0) {
      ...
      a.push({
        ...
        "success1" == e ? ($(".wpts-popup-return-data").html("Attendance entered successfully!"), $("#SuccessModal").css("display", "block"), $("#SavingModal").css("display", "none"), $("#SuccessModal").addClass("wpts-popVisible"), $("#AttendanceEntryForm").trigger("reset"), setTimeout(function() {
          $(".alert").remove(), $("#SuccessModal").css("display", "none"), $("#AttendanceView").click()
        }, 2e3)) : "updated" == e ? ($(".wpts-popup-return-data").html("Attendance updated successfully!"), $("#SuccessModal").css("display", "block"), $("#SavingModal").css("display", "none"), $("#SuccessModal").addClass("wpts-popVisible"), setTimeout(function() {
          $(".alert").remove(), $("#SavingModal").modal("hide"), $("#AttendanceView").click()
        }, 1500)) : ($(".wpts-popup-return-data").html("Operation failed.Something went wrong!"), $("#SavingModal").css("display", "none"), $("#WarningModal").css("display", "block"), $("#WarningModal").addClass("wpts-popVisible"))
      })
    ...
    if (confirm("Are you want to delete this entry?")) {
      ...
      if ("" == e) $(".wpts-popup-return-data").html("Attendance information Missing!"), $("#SavingModal").css("display", "none"), $("#WarningModal").css("display", "block"), $("#WarningModal").addClass("wpts-popVisible");
      else {
        var a = [];
        a.push({
          name: "action",
          ...
          beforeSend: function() {},
          success: function(e) {
            $(".wpts-popup-return-data").html("Attendance entry deleted successfully.."), $("#SuccessModal").css("display", "block"), $("#SavingModal").css("display", "none"), $("#SuccessModal").addClass("wpts-popVisible")
          },
          error: function() {
    ...
    } else $(".wpts-popup-return-data").html("Teacher ID Missing.."), $("#SavingModal").css("display", "none"), $("#WarningModal").css("display", "block"), $("#WarningModal").addClass("wpts-popVisible")
