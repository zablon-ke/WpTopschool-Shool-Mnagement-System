  ...
  $("#sessions_template").change(function() {
    ...
    onDrop: function(e, a) {
      if ($(this).removeClass("over"), $(a).hasClass("assigned")) $(this).append(a);
        ...
        var s = $(this).data("sessionid"),
          ...
          i = $(a).clone().removeClass("item").addClass("wpts-assigned-item assigned item1");
        i.append('<a href="javascript:void(0)" class="daleteid wpts-tt-delete-icon" data-id="' + s + '" data-rowid="' + t + '"  ></a>');
        $(this).empty().append(i), i.draggable({
          revert: !0
        })
      }
      $("#ajax_response").html("<p class='wpts-bg-green'>Saving..</p>");
      var l = $("#class_id").val(),
        n = $(this).attr("tid"),
      ...
      u.push({
        ...
        "true" == i || "updated" == i ? (2 == s ? $("#ajax_response_exist").html("<p class='wpts-bg-yellow'> This Teacher also assigned to class </p>" + t) : $("#ajax_response_exist").html(""), $("#ajax_response").html("<p class='wpts-bg-green'>Saved..</p>")) : $("#ajax_response").html("<p class='wpts-bg-red'> Not Saved..</p>")
      })
    }
    ...
    if (1 == confirm("Are you sure want to delete class Timetable?")) {
      ...
      a.push({
        ...
        beforeSend: function() {},
        success: function(e) {
          "deleted" == e ? ($(".wpts-popup-return-data").html("Time Table Deleted Successfully"), $("#SuccessModal").css("display", "block"), $("#SavingModal").css("display", "none"), $("#SuccessModal").addClass("wpts-popVisible")) : ($(".wpts-popup-return-data").html("Try Again Later"), $("#SavingModal").css("display", "none"), $("#WarningModal").css("display", "block"), $("#WarningModal").addClass("wpts-popVisible"))
        },
        complete: function() {
          $(".pnloader").remove()
        }
