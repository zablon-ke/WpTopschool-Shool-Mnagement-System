      ...
      a.append("action", "UpdateStudent"), a.append("displaypicture", t), $.each(s, function(e, s) {
        ...
        success: function(e) {
          if ($("#studentform").removeAttr("disabled"), "success0" == e) {
            $(".wpts-popup-return-data").html("Student update successfully !"), $("#SuccessModal").css("display", "block"), $("#SavingModal").css("display", "none"), $("#SuccessModal").addClass("wpts-popVisible");
            var a = $("#wpts_locationginal").val() + "admin.php?page=sch-editprofile";
            setTimeout(function() {
      ...
      a.append("action", "UpdateStudent"), a.append("displaypicture", t), $.each(s, function(e, s) {
        ...
        success: function(e) {
          if ($("#parentform").removeAttr("disabled"), "success0" == e) {
            $(".wpts-popup-return-data").html("Parent updated successfully !"), $("#SuccessModal").css("display", "block"), $("#SavingModal").css("display", "none"), $("#SuccessModal").addClass("wpts-popVisible");
            var a = $("#wpts_locationginal").val() + "admin.php?page=sch-editprofile";
            setTimeout(function() {
              window.location.href = a
            }, 1e3);
        ...
        error: function() {
          $("#SavingModal").css("display", "none"), $("#WarningModal").css("display", "block"), $("#WarningModal").addClass("wpts-popVisible"), $("#parentform").removeAttr("disabled")
        },
        complete: function() {
