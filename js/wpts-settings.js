$(document).ready(function() {
  $("#wp-end-time").timepicker({
    ...
    a.append("action", "GenSettinglicensing"), $.each(s, function(e, s) {
      ...
      contentType: !1,
      success: function(e) {
        "success" == e ? ($(".wpts-popup-return-data").html("Information Saved Successfully"), $("#SuccessModal").css("display", "block"), $("#SavingModal").css("display", "none"), $("#SuccessModal").addClass("wpts-popVisible"), window.location.reload()) : ($(".wpts-popup-return-data").html("Something went wrong"), $("#SavingModal").css("display", "none"), $("#WarningModal").css("display", "block"), $("#WarningModal").addClass("wpts-popVisible"))
      },
      complete: function() {
        $(".pnloader").remove()
      }
    ...
    a.append("action", "GenSetting"), a.append("displaypicture", i), $.each(s, function(e, s) {
      ...
      success: function(e) {
        $("#setting_submit").attr("disabled", !1), "success" == e ? ($(".wpts-popup-return-data").html("Information Saved Successfully"), $("#SuccessModal").css("display", "block"), $("#SavingModal").css("display", "none"), $("#SuccessModal").addClass("wpts-popVisible"), window.location.reload()) : ($(".wpts-popup-return-data").html("Something went wrong"), $("#SavingModal").css("display", "none"), $("#WarningModal").css("display", "block"), $("#WarningModal").addClass("wpts-popVisible"))
      },
      complete: function() {
    ...
    a.append("action", "GenSettingsms"), $.each(s, function(e, s) {
      ...
      beforeSend: function() {},
      success: function(e) {
        "success" == e ? ($(".wpts-popup-return-data").html("Teacher Updated successfully !"),
		$("#SuccessModal").css("display", "block"),
		$("#SavingModal").css("display", "none"),
		$("#SuccessModal").addClass("wpts-popVisible")) : ($(".wpts-popup-return-data").html("Something went wrong"), $("#SavingModal").css("display", "none"), $("#WarningModal").css("display", "block"), $("#WarningModal").addClass("wpts-popVisible"))
      },
      complete: function() {
        $(".pnloader").remove()
      }
  ...
  }), $("#wpts_grade_list, #wpts_sub_division_table,#wpts_class_hours").dataTable({
    language: {
      paginate: {
  ...
  $("#SubFieldsClass").change(function() {
      ...
      success: function(e) {
        if ("success" == e) {
         /* $.fn.notify("success", {
          ...
          var a = $("#wpts_locationginal").val() + "/admin.php?page=sch-settings&sc=subField";
          setTimeout(function() {
            window.location.href = a
          }, 1e3)
        } else $(".wpts-popup-return-data").html("Something went wrong!"), $("#SavingModal").css("display", "none"), $("#WarningModal").css("display", "block"), $("#WarningModal").addClass("wpts-popVisible")
      },
      error: function() {
    ...
    s.push({
      ...
      success: function(e) {
        if ("success" == e) {
          var a = 1e3,
            s = $("#wpts_locationginal").val() + "/admin.php?page=sch-settings&sc=subField";
          setTimeout(function() {
            window.location.href = s
          }, a);
          $("#DeleteModal").css("display", "none"), ".wpts-popup-return-data".html("Update successfully!"), $("#SuccessModal").css("display", "block"), $("#SavingModal").css("display", "none"), $("#SuccessModal").addClass("wpts-popVisible");
          a = 1e3, s = $("#wpts_locationginal").val() + "/admin.php?page=sch-settings&sc=subField", setTimeout(function() {
            window.location.href = s
          }, a)
        } else $(".wpts-popup-return-data").html("Operation failed.Something went wrong!");
        $("#SavingModal").css("display", "none"), $("#WarningModal").css("display", "block"), $("#WarningModal").addClass("wpts-popVisible")
      },
      error: function() {
