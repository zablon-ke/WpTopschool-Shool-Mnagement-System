  ...
  $("#ExStart").datepicker({
    ...
    submitHandler: function(a) {
      ...
      e.push({
        ...
        success: function(a) {
          if ("success" == a) {
            $(".wpts-popup-return-data").html("Exam Created Successfully !"), $("#SuccessModal").css("display", "block"), $("#SavingModal").css("display", "none"), $("#SuccessModal").addClass("wpts-popVisible");
            var e = $("#wpts_locationginal").val() + "/admin.php?page=sch-exams";
            setTimeout(function() {
    ...
    submitHandler: function(a) {
      ...
      e.push({
        ...
        success: function(a) {
          if ("updated" == a) {
            $(".wpts-popup-return-data").html("Exam information updated Successfully !"), $("#SuccessModal").css("display", "block"), $("#SavingModal").css("display", "none"), $("#SuccessModal").addClass("wpts-popVisible");
            var e = $("#wpts_locationginal").val() + "/admin.php?page=sch-exams";
            setTimeout(function() {
              window.location.href = e
            }, 1e3);
    ...
    $(".action-button").attr("disabled", "disabled"), e.push({
      ...
      $.each(e.subject, function(a, e) {
        t += '<input type="checkbox" name="subjectid[]" value="' + e.id + '" class="exam-subjects wpts-checkbox" id="subject-' + e.id + '"><label for="subject-' + e.id + '" class="wpts-checkbox-label">' + e.sub_name + "</label>"
