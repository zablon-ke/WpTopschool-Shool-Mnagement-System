$(document).ready(function() {
  $("input.numbers").bind("keypress", function(a) {
    ...
    changeYear: !0,
    startDate: "0m"
  }), $(".wpts-start-date").on("change", function() {
    console.log($(".wpts-start-date").val()), $(".wpts-end-date").datepicker("remove"), $(".wpts-end-date").datepicker({
      autoclose: !0,
      dateFormat: date_format,
      todayHighlight: !0,
      changeMonth: !0,
      changeYear: !0,
      startDate: $(".wpts-start-date").val(),
      setStartDate: $(".wpts-start-date").val()
    }), $(".wpts-end-date").datepicker("update", $(".wpts-start-date").val())
    ...
    submitHandler: function(a) {
      ...
      e.push({
        ...
        success: function(a) {
          if ("inserted" == a) {
            $(".wpts-popup-return-data").html("Class created successfully !"), $("#SuccessModal").css("display", "block"), $("#SavingModal").css("display", "none"), $("#SuccessModal").addClass("wpts-popVisible");
            var e = $("#wpts_locationginal").val() + "/admin.php?page=sch-class";
            setTimeout(function() {
    ...
    submitHandler: function(a) {
      ...
      e.push({
        ...
        success: function(a) {
          if ("updated" == a) {
            $(".wpts-popup-return-data").html("Class updated successfully !"), $("#SuccessModal").css("display", "block"), $("#SavingModal").css("display", "none"), $("#SuccessModal").addClass("wpts-popVisible");
            var e = $("#wpts_locationginal").val() + "/admin.php?page=sch-class";
            setTimeout(function() {
              window.location.href = e
            }, 1e3);
