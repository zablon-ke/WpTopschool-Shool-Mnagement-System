...
(function( $, window, document, undefined ) {
...

	{
		...
		var filter = $('<div/>', {
			...
			.append( $('<label class="wpts-label"/>' ).append( str ) );
...

	{
		...
		var div = $('<div><label class="wpts-label"/></div>').addClass( classes.sLength );
...
$.extend( true, DataTable.defaults, {
	...
	dom:
		...
		"<'wpts-row'<'wpts-col-sm-6'l><'wpts-col-sm-6'f>>" +



		"<'wpts-row'<'wpts-col-sm-12'tr>>" +



		"<'wpts-row'<'wpts-col-sm-5'i><'wpts-col-sm-7'p>>",
...
$.extend( DataTable.ext.classes, {
	...
	sFilterInput:  "wpts-form-control wpts-input-sm",



	sLengthSelect: "wpts-form-control wpts-input-sm",
