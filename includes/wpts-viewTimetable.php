...
function wpts_ViewTimetable($class_id){
        global $wpdb;
        ...
        if ($get_heading == null) {
            echo '<section class="content">
                    <div class="wpts-text-red">Timetable Has Not Created For This Class.</div>
                </section> </div></div>';
            $response['status'] =   1;
        } else {
            $response['status'] =   2;
            ...
            $ses_info = $wpdb->get_results("Select * from $wpts_hours_table");
            ...
            ?>
             <section>
                ...
                <div class="wpts-row">
                    ...
                    <table class="wpts-table wpts-table-bordered"  id="timetable_table" cellspacing="0" width="100%" style="width:100%">
                        <thead>
                            <tr>
                                <th><?php esc_html_e( 'Week', 'wptopschool' ); ?></th>
